...
#pragma config(Sensor, dgtl4,  RedLED2,        sensorDigitalOut)
...
void test2(){
		if(objectPlacementThreshholdLower < SensorValue[sonarSensor] < objectPlacementThreshholdUpper){
...
const int wallThreshhold = 7;	//in cm
